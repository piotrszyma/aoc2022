...
class Stacks:
    ...
    def move(self, command: Command):
        source_stack = self.at(command.source)
        source_items = source_stack.items

        target_stack = self.at(command.target)
        target_items = target_stack.items

        new_target_items = [*target_items, *source_items[-command.count :]]
        new_source_items = [*source_items[: -command.count]]

        target_stack.items = new_target_items
        source_stack.items = new_source_items
